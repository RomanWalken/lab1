package com.mjavka.simple.lab1.genealogyTree;

import com.mjavka.simple.lab1.exceptions.RelativesException;
...
public class Person implements Comparable<Person> {
    ...
    public void addToUser(String username) throws ClassNotFoundException {
        ...
        try (Connection connection = DriverManager.getConnection("jdbc:mysql://localhost:3306/tree", "root", "12345")) {
            if (connection != null) {
